            ...
            <div class="tab-content">
                <div id="tab-1" class="tab-pane active">
                    <div class="panel-body">
                        ...
                        <hr>
                        <?php
                        $title = isset($posted['from_date']) ? 'รายงานระยะเวลารอคอยคิวการเงิน'.' ('.Yii::$app->formatter->asDate($posted['from_date'], 'php:d F Y').' - '.Yii::$app->formatter->asDate($posted['to_date'], 'php:d F Y').')' : 'รายงานระยะเวลารอคอยคิวการเงิน';
                        echo GridView::widget([
                            ...
                            'exportConfig' => [
                                GridView::PDF => [
                                    ...
                                    'showFooter' => true,
                                    'showCaption' => true,
                                    'filename' => 'รายงานระยะเวลารอคอยคิวการเงิน',
