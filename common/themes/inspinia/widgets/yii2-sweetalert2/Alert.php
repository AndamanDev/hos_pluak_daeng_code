...
namespace inspinia\sweetalert2;
...
use inspinia\sweetalert2\assets\AnimateCssAsset;
use inspinia\sweetalert2\assets\PolyfillAsset;
...
class Alert extends Widget
{
    ...
    {
        parent::init();
        //PolyfillAsset::register($this->view);
